...
class TiendaLibros:
    ...
    def adicionar_libro_a_catalogo(self, isbn:str, titulo:str,precio:float,existencias:int)-> Libro:
        ...
        print(f"El libro cuyo isbn es: {isbn}, titulado: {titulo}, con un coste de {precio} y con {existencias} existencias, fue agregado con éxito.")
    ...
    def agregar_libro_a_carrito(self,libro:Libro,cantidad_unidades_a_comprar:int):
        ...
        print(f"El libro cuyo isbn es: {libro.isbn} ha sido agregado exitosamente al carrrito de compras")
